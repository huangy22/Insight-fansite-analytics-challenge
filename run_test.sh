...
python ./src/process_log.py ./log_input/log_test2.txt ./log_output/hosts_test.txt ./log_output/hours_test.txt ./log_output/resources_test.txt ./log_output/blocked_test.txt
