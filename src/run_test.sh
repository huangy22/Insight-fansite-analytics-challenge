...
python ./process_log.py ../log_input/log_test_err.txt ../log_output/hosts_test.txt ../log_output/hours_test.txt ../log_output/resources_test.txt ../log_output/blocked_test.txt
